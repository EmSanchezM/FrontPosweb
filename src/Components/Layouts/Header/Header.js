...
/*
<li className="nav-item pcoded-menu-caption"><label htmlFor="">Compras</label></li>
...
<li className="nav-item pcoded-menu-caption"><label htmlFor="">Inventario</label></li>
    <li className="nav-item">
...
<li className="nav-item pcoded-hasmenu">
                                <Link className="nav-link" to="#!">
                                    ...
                                    <span className="pcoded-mtext">Recursos Humanos</span>
                                </Link>
                                <ul className="pcoded-submenu">
                                    <li>
                            ...
                            <li className="nav-item pcoded-hasmenu">
                                <a className="nav-link" to="#!">
                                    <span className="pcoded-micon"><i className="ti-package"></i></span>
                                    <span className="pcoded-mtext">Inventario</span>
                                </a>
                                <ul className="pcoded-submenu">
                                    <li>
                                        <Link className="nav-link pcoded-hasmenu" to={'/admin/categorias'}>
...
<li className="nav-item pcoded-hasmenu">
                                <Link className="nav-link" to="#!" onClick={preventDefault}>
                                    ...
                                    <span className="pcoded-mtext">Compras</span>
                                </Link>
                                <ul className="pcoded-submenu">
                                    <li>
                                        <Link className="nav-link pcoded-hasmenu" to={'/admin/ordenescompras'}>
                ...
                <div className="navbar-wrapper">
                    <div className="navbar-content scroll-div">
                        ...
                        <ul className="nav pcoded-inner-navbar">
                            ...
                            <li>
                                <Link className="nav-link pcoded-hasmenu" to={'/admin/ordenescompras'}>
                                    <span className="pcoded-micon"><i className="ti-write"></i></span>
                                    <span className="pcoded-mtext">Ordenes de Compra</span>
                                </Link>
                            </li>
                            <li>
                                <Link className="nav-link pcoded-hasmenu" to={'/admin/compras'}>
                                    <span className="pcoded-micon"><i className="ti-shopping-cart-full"></i></span>
                                    <span className="pcoded-mtext">Compras</span>
                                </Link>
                            </li>
